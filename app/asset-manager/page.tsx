    ...
    return (
        <div>
            ...
            <section className="pt-8 px-36 max-md:px-10 max-xl:px-20">
                <SubTitle subTitle="What is a Multi Account Manager?" otherClass="font-bold" />
                <Description
            ...
            <section className="pt-8 px-36 max-md:px-10 max-xl:px-20">
                <SubTitle subTitle="Benefits and Features of the Multi Account Managers" otherClass="font-bold" />
                <ul className="mt-8">
            ...
            <section className="pt-8 px-36 max-md:px-10 max-xl:px-20">
                <SubTitle subTitle="Customisable Trading Conditions " otherClass="font-bold" />
                <Description
            ...
            <section className="pt-8 pb-16 px-36 max-md:px-10 max-xl:px-20">
                <SubTitle subTitle="Add/Remove Funds Without Affecting Trading Activity" otherClass="font-bold" />
                <Description
