  ...
  return (
    <div>
      ...
      <section className="px-36 pt-16 max-sm:p-16 max-md:px-10 max-xl:px-20">
        <SubTitle subTitle={"1. GENERAL STATEMENT"} otherClass={"font-bold "} />
        <Description
          description={
            "Axiontrade (Cambodia) Co., Ltd. (hereinafter called the “Company”) is registered in Cambodia with Company Registration Number 1000179787, and is approved by the Securities and Exchange Regulator (SERC) of Cambodia to operate under a Derivative Broker License (in-principle approval of License No. 038)."
          }
      ...
      <section className="px-36 pt-8 max-sm:p-16 max-md:px-10 max-xl:px-20">
        <SubTitle subTitle={"2. PRIVACY NOTICE"} otherClass={"font-bold "} />
        <Description
          description={
