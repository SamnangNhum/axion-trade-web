...
const policySections = [
  ...
  },
  {
    ...
    description:
      "By continuing to use our Website, you are agreeing to our placing cookies on your computer in order to analyse the way you use our Website. If you do not wish to accept cookies in connection with your use of this Website, you must stop using our Website",
    otherClass: "",
  },
];
...
export default async function CookiesPolicy({
  ...
  return (
    <div>
      ...
      <section className="px-36 pt-8 max-sm:p-16 max-md:px-10 max-xl:px-20">
        <SubTitle
          subTitle="The way in which we use cookies Session Cookies"
          otherClass="font-bold"
        />
        <Description
          description={"We use persistent cookies for the following purposes:"}
      ...
      <section className="px-36 pt-8 max-sm:p-16 max-md:px-10 max-xl:px-20">
        <SubTitle
          subTitle="We use persistent cookies for the following purposes:"
          otherClass="font-bold"
        />
        <Description
          description={"We use persistent cookies for the following purposes:"}
      ...
      <section className="px-36 py-8 max-sm:p-16 max-md:px-10 max-xl:px-20">
        <SubTitle
          subTitle="Third parties serve cookies via this site. These are used for the following purposes:"
          otherClass="font-bold"
        />
        <Description
          description={"We use persistent cookies for the following purposes:"}
      ...
      <section className="px-36 pb-16 max-sm:p-16 max-md:px-10 max-xl:px-20">
        ...
        <p className="text-md text-gray-500">
          If you wish to know more about cookies please consult the help menu on
          your web browser or visit independent information providers such as{" "}
          <a className="text-black" href="">
            www.allaboutcookies.org.{" "}
          </a>{" "}
          If you have any questions regarding our privacy or security measures,{" "}
          <a className="text-black" href="">
            please email accounts@axiontrade.com.kh
          </a>
        </p>
      </section>
    </div>
