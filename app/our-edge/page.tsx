            ...
            <section className="px-36 max-sm:px-10 max-md:px-10 max-xl:px-20 -translate-y-20 max-md:-translate-y-20">
                <div className="grid grid-cols-4 gap-4 max-md:grid-cols-1 max-xl:grid-cols-2">
                    {counts.map((count, index) => (
                        <div key={index} className="text-center shadow-lg py-16 px-10 rounded-xl bg-white max-md:px-0">
            ...
            <section className="px-36  max-sm:px-16 max-md:px-10 max-xl:px-20">
                <div className="grid grid-cols-2 gap-4 max-md:grid-cols-1">
                    <div className="flex items-center justify-center ">
                        <div>
                            <SubTitle subTitle={"Trusted Worldwide, Recognized Everywhere"} otherClass={"font-bold text-blue-500"} />
                            <Title title={"Credibility and Global Recognition"} />

                            <Description description={"Axion Trade has over 10,000 clients from 30 different countries"}
            ...
            <section className=" pb-16 px-36 max-md:px-10 max-xl:px-20">
                <div className="grid grid-cols-2 gap-4  max-md:grid-cols-1">
                    <div className="max-md:order-1">
                        ...
                        />
                        <Description
                            description={"This world-class infrastructure is set up to ensure that all clients receive a trading experience like no other. Ultra-speed execution and low latency connection accessible anytime, anywhere."}
                            otherClass={"text-gray-500"}
                        />
                    </div>
                ...
                <div className="grid grid-cols-2 gap-4  max-md:grid-cols-1">
                    <div className="max-md:order-1">
                        ...
                        <Description
                            description={"In an increasingly volatile market, there may be rare scenarios where clients may face losses exceeding their capital. To protect clients’ interests, Axion Trade has introduced Negative Balance Protection which allows affected clients to remove any negative balance on their trading accounts. Trade without worry on unintended trade losses exceeding your available trading capital."}
                            otherClass={"text-gray-500"}
                        />
                    </div>
                    <div className="flex items-center justify-center  max-md:order-2">
                        <Image src="/negative-balance-protection.png" width={400} height={400} alt="Client Focused" />
                    </div>
                </div>
