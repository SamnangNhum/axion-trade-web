...
export default function OurEdge() {
    ...
    return (
        <div>
            ...
            <section className="py-16 px-36 max-md:px-10 max-xl:px-20">
            ...
            <section className=" pb-16 px-36 max-md:px-10 max-xl:px-20">
                <div className="grid grid-cols-2 gap-4  max-md:grid-cols-1">
                    ...
                    <div className="flex items-center justify-center  max-md:order-2">
                        <Image src="/client-focuses.png" width={400} height={400} alt="Client Focused" />
                    </div>
                </div>
                <div className="grid grid-cols-2 gap-4  max-md:grid-cols-1">
                    <div className="flex items-center justify-center  max-md:order-2">
                    ...
                    <div className="max-md:order-1">
                        <SubTitle subTitle={"24-Hour Dedicated Support"} otherClass={"max-md:text-lg"} />
                        <Description
