        ...
        <div>
            ...
            <section>
                <section className="pt-8 px-36 max-md:px-10 max-xl:px-20">
                    <SubTitle subTitle="Fully Branded White Label Solution" otherClass="font-bold" />
                    <Description
